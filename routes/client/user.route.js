...
//become influencer
route.post("/becomeInfluencer", checkAccessWithSecretKey(), UserController.becomeInfluencer);
route.patch("/becomeInfluencer", checkAccessWithSecretKey(), UserController.becomeInfluencer);

//get influencers filtered by tab
route.get("/getInfluencers", checkAccessWithSecretKey(), UserController.getInfluencers);

//check follow status and follow influencer
route.get("/checkFollowStatus", checkAccessWithSecretKey(), UserController.checkFollowStatus);
route.post("/followInfluencer", checkAccessWithSecretKey(), UserController.followInfluencer);
