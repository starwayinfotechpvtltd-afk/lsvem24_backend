...
const userSchema = new mongoose.Schema(
  {
    ...
    channelType: { type: String, default: "Artist", trim: true },
    channelCategory: { type: String, default: "Artist", trim: true },
    ...
    influencerSocialLinks: { type: [String], default: [] }, // Max 4 social media links
    ...
    influencerProductLinks: { type: [String], default: [] }, // Max 2 product links
    ...
    coin: { type: Number, default: 0 },
    purchasedCoin: { type: Number, default: 0 }, //when coin plan purchased using money
    earnedCoin: { type: Number, default: 0 }, //when coin earned from app activities (daily rewards, video watch, like, comment, referral, login, etc.)
